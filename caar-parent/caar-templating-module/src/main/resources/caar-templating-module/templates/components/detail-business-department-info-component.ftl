...
<section class="cmp-empresa-detalle cmp-empresa-info-despacho">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <span>${businessModel.getLegalName(businessContentNode)!""}</span>
                <p>¿Dirección?</p>
            </div>
            ...
            <div class="col-md-7 descript-emp">
                <div class="info">
                    ...
                    [#if businessModel.getDepartmentWebSite(businessContentNode)??]<div><i class="fa fa-link" aria-hidden="true"></i> <a href="${cmsfn.externalLink(businessContentNode, businessModel.getDepartmentWebSiteFieldName())}">${businessModel.getDepartmentWebSite(businessContentNode)!""}</a></div>[/#if]
                </div>
                <p>¿?</p>
            </div>
        </div>
